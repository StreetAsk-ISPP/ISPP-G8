...
import { Text, TextInput, View, StyleSheet, Image, TouchableOpacity, ScrollView, useWindowDimensions } from 'react-native';
...
export default function SignUpScreen({ navigation }) {
	...
	const formMaxWidth = isLargeScreen ? 560 : 460;
	const formHorizontalPadding = isSmallScreen ? 16 : 24;
	const logoSize = isSmallScreen ? 72 : 80;
		...
		<View style={globalStyles.screen}>
			...
			>
				<View style={styles.container}>
					...
					{/* Form Fields */}
					<View style={[styles.form, { maxWidth: formMaxWidth, paddingHorizontal: formHorizontalPadding }]}>
						...
						<View style={styles.buttonsSection}>
							...
							<View style={[styles.buttonsRow, isNarrowScreen && styles.buttonsColumn]}>
