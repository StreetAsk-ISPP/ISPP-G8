...
<%--
StreetAsk :: Community Task Management
--%>
...
<head>
    ...
    <title>StreetAsk :: Community Task Management</title>

    <%-- CSS generated from LESS --%>
    <spring:url value="/resources/css/streetask.css" var="streetaskCss"/>
    <link href="${streetaskCss}" rel="stylesheet"/>
