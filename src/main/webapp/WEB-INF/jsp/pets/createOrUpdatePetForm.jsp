    ...
    <jsp:body>
        ...
        <form:form modelAttribute="pet"
            ...
            <div class="form-group has-feedback">
                ...
                <streetask:inputField label="Name" name="name"/>
                <streetask:inputField label="Birth Date" name="birthDate"/>
                <div class="control-group">
                    <streetask:selectField name="type" label="Type " names="${types}" size="5"/>
                </div>
            </div>
            <div class="form-group">
