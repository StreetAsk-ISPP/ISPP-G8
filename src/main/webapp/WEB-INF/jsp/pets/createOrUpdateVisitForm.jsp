            ...
            <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
                <%@ taglib prefix="streetask" tagdir="/WEB-INF/tags" %>
                    ...
                    <streetask:layout pageName="owners">
                        ...
                        <jsp:body>
                            <h2>
                                <c:if test="${visit['new']}">New </c:if>Visit
                            </h2>
                            ...
                            <table class="table table-striped">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <streetask:localDate date="${visit.pet.birthDate}" pattern="yyyy/MM/dd" />
                                    </td>
                                    <td>
                            ...
                            <form:form modelAttribute="visit" class="form-horizontal">
                                <div class="form-group has-feedback">
                                    <streetask:inputField label="Date" name="date" />
                                    <streetask:inputField label="Description" name="description" />
                                </div>
                            ...
                            <table class="table table-striped">
                                ...
                                <c:forEach var="visit" items="${visit.pet.visits}">
                                    <c:if test="${!visit['new']}">
                                        <tr>
                                            <td>
                                                <streetask:localDate date="${visit.date}" pattern="yyyy/MM/dd" />
                                            </td>
                                            <td>
