...
- Generated at (UTC): `2026-03-15 10:23:11`
- Lookback window: last `30` days (weekly metrics use last `7` days)

| Metric | Value | Status | Threshold |
|---|---:|---|---|
| Lead Time (Done Issues) | 2.65 days (n=128) | 🟢 Good | <= 3 days |
...
| Average PR Review Time | 10.51h (n=72) | 🟢 Good | < 48h |
| % Issues with Assignee | 82.35% assigned (17.65% unassigned) | 🔴 Poor | > 5% unassigned |
| Closed / Open Issues Ratio | 9.41 (closed=160, open=17) | 🟢 Good | >= 1 |
